    ...
    <nav className={`navbar ${scrolled ? 'scrolled' : ''}`}>
      <div className="nav-container">
        ...
        <div className="logo-section">
          ...
          />
          <span className="tagline">Revise Life • Release Vices</span>
        </div>
    ...
    <>
      ...
      <section className={`hero-section ${isVisible ? 'visible' : ''}`}>
        ...
        <div className="floating-phones">
          <div className="float-phone float-phone-1"></div>
          <div className="float-phone float-phone-2"></div>
          <div className="float-phone float-phone-3"></div>
        </div>

        <div className="hero-content">
          <div className="hero-badge">AI-POWERED RECOVERY</div>
          
          <h1 className="hero-title">
            <span className="hero-title-gradient">Revise Your Life.</span><br />
            Release Your Vices.
          </h1>
          
          <p className="hero-subtitle">
            Transform tomorrow by taking control today.<br />
            Your AI companion for lasting change.
          </p>
          ...
          <div className="phone-showcase">
            <div className="phone-mockup">
              <div className="phone-screen">App Screenshot</div>
            </div>
          </div>
        </div>
      </section>
